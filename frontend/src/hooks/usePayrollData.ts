  ...
  const filteredPayrolls = useMemo(() => {
    return payrolls.filter(payroll => {
      const matchesSearch = !filters.search || 
        payroll.User.name.toLowerCase().includes(filters.search.toLowerCase()) ||
        payroll.User.email.toLowerCase().includes(filters.search.toLowerCase()) ||
        payroll.User.department.toLowerCase().includes(filters.search.toLowerCase());
