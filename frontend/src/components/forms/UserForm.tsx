...
export function UserForm({
  ...
  const handleAvatarUploadSuccess = (profileImageUrl: string, thumbnailImageUrl: string) => {
    ...
    // Optionally refresh the data to get updated User info
    onSuccess();
  };
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Avatar Upload Section - Only show for edit mode with existing User */}
          ...
          {mode === 'create' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-700">
                💡 <strong>Tip:</strong> You can upload an avatar after creating the User record.
              </p>
            </div>
          )}
