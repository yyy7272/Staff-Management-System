  ...
  const columns: TableColumn<Payroll>[] = [
    {
      ...
      render: (payroll) => (
        <div>
          ...
          <div className="text-sm text-muted-foreground">{payroll.User.department}</div>
        </div>
      )
    },
    {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        description="Manage User payroll records, process payments, and view salary statistics"
          ...
          <Card>
            ...
            <CardContent>
              <SearchFilterBar
                ...
                searchPlaceholder="Search by User name, email, or department..."
                ...
                emptyMessage={
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                      Get started by creating your first payroll record or generating payroll for all users.
                    </p>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p>{selectedPayroll.User.name}</p>
                  <p className="text-sm text-muted-foreground">{selectedPayroll.User.department}</p>
                </div>
                <div>
