import type { User, Department, ApprovalItem, Role, Permission, ApiResponse, FilterOptions } from './common';
...
export interface EmployeeApi {
  getAll: (filters?: FilterOptions) => Promise<ApiResponse<User[]>>;
  getById: (id: string) => Promise<ApiResponse<User>>;
  create: (data: EmployeeCreateRequest) => Promise<ApiResponse<User>>;
  update: (id: string, data: EmployeeUpdateRequest) => Promise<ApiResponse<User>>;
